...
namespace Filesystem {
		...
		public:
			WaveReader(const String &file) throw (...)
			...
			void readFile(IHostMultiChannel<SampleType> &multiChannel)
			{
                fff_EXPECT(multiChannel.getChannelCount(),
                ==, getChannelCount());
                fff_EXPECT(multiChannel.getSampleCount(),
                >=, getSampleCount());
